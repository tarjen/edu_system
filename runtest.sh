...
# PYTHONPATH=$PYTHONPATH:. coverage run -m pytest online_judge/test/test_problem_selection.py 
# PYTHONPATH=$PYTHONPATH:. coverage run -m pytest online_judge/test/test_create_problem.py 
# PYTHONPATH=$PYTHONPATH:. coverage run -m pytest online_judge/test/test_incontest.py 
